...
class AppLocalizationsVi extends AppLocalizations {
  ...
  String achievementTitle(String id) {
    switch (id) {
      ...
      case 'harvest_80': return 'Người làm vườn';
      case 'harvest_160': return 'Nông dân bậc thầy';
      case 'garden_points_1000': return 'Vườn sinh lợi';
      case 'garden_points_3000': return 'Khu vườn phồn thịnh';
      case 'garden_points_6000': return 'Nông trang trù phú';
      ...
      case 'aquarium_points_10000': return 'Vận may đại dương';
  ...
  String achievementDescription(String id) {
    switch (id) {
      ...
      case 'harvest_80': return 'Thu hoạch cây 80 lần';
      case 'harvest_160': return 'Thu hoạch cây 160 lần';
      case 'garden_points_1000': return 'Kiếm 1.000 điểm từ làm vườn';
      case 'garden_points_3000': return 'Kiếm 3.000 điểm từ làm vườn';
      case 'garden_points_6000': return 'Kiếm 6.000 điểm từ làm vườn';
      ...
      case 'aquarium_points_10000': return 'Kiếm 10.000 điểm từ bể cá';
